...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.php">MyDelivey | SUSHI TIME</a>
                  ...
                  <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                    <tr>
                      ...
                      <?php
                        ...
                        $displayStaffQuery = "SELECT * FROM clientes";
                        ...
                        if ($result = $sqlconnection->query($displayStaffQuery)) {
                          ...
                          ?>
                              ...
                              <td><?php echo $staff['fecha_nacimiento']; ?></td>
                              <td><?php echo $staff['compras']; ?></td>
                              <td><?php echo $staff['ultima_compra']; ?></td>
                              <td><?php echo $staff['fecha']; ?></td>

                              <td>
                                <form method="POST">


		<a href="#editItemModal" data-toggle="modal" class="btn btn-sm btn-warning" data-itemname="<?php echo $menuItemRow["menuItemName"] ?>" data-itemprice="<?php echo $menuItemRow["price"] ?>" data-menuid="<?php echo $menuRow["menuID"] ?>" data-itemid="<?php echo $menuItemRow["itemID"] ?>">Editar </a>
    <a href="deleteclient.php?id=<?php echo $staff['id']; ?>" class="btn btn-sm btn-danger">Eliminar</a>
    <!-- Edit Item Modal -->
  	<div class="modal fade" id="editItemModal" tabindex="-1" role="dialog" aria-labelledby="editItemModalLabel" aria-hidden="true">
  	  <div class="modal-dialog" role="document">
  	    <div class="modal-content">
  	      <div class="modal-header">
  	        <h5 class="modal-title" id="addItemModalLabel">Editar Cliente</h5>
  	      ...
  	      <div class="modal-body">
  	        <form id="edititemform" action="edititem.php" method="POST">
  	        	<div class="form-group">
  		            ...
  		            <input type="text" required="required" id="clientname" class="form-control" name="clientname" placeholder="Sopa,Pepsi,etc" >
  		        </div>
              <div class="form-group">
                  <label class="col-form-label">Direccion:</label>
                  <input type="text" required="required" id="clientad" class="form-control" name="clientad" placeholder="Sopa,Pepsi,etc" >
              </div>
              <div class="form-group">
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © Sushi Time 2020</span>
            </div>
          </div>
        </footer>
