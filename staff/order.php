...
<html lang="en">
  ...
  <head>
    ...
    <link href="css/sb-admin.css" rel="stylesheet">
		...
		<script src="staff/js/jquery-3.4.1.min.js"></script>
		<script src="staff/js/bootstrap.min.js"></script>
		<script src="staff/js/buscar.js"></script>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
									...
									<script src="JS/buscar.js"></script>
											...
											<a class="navbar-brand text-monospace" href="#">BUSCADOR DE CLIENTES <i class="fas fa-search"></i></a>
											<input class="form-control mr-sm-4" type="text" name="termino" id="termino" placeholder="Digite el telefono del cliente que desea buscar..." aria-label="Search">
